...
observer.observe(document.querySelector('.modelGames'));
...
const canvas1 = document.getElementById("modelGames"); // Get the canvas element
...
const createScene1 = function () {
	...
	BABYLON.SceneLoader.Append("3D/", "model_1.glb", scene, function (mesh) {
		...
		mesh.activeCamera.alpha += Math.PI*0.2;
